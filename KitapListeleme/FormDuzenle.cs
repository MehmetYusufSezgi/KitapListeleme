    ...
    public partial class FormDuzenle : Form
    {
        ...
        private void buttonDegistir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //UPDATE metodu.
                SqlCommand updateCommand = new SqlCommand("UPDATE TBLKitaplar SET YazarAdi = @p2, SayfaSayisi = @p3, OkunmaTarihi = @p4, BasimTarihi = @p5, OduncVerilen = @p6, OduncTarihi = @p7 WHERE KitapAdi = @p1", SqlConnection);
