...
namespace KitapListeleme
{
    public partial class FormSil : Form
    {
        ...
        private void buttonSil_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection.Open();
            int satirSayisi = 0;
            SqlCommand countCommand = new SqlCommand("SELECT COUNT(*) FROM TableKitaplar WHERE KitapAdi = @p1", SqlConnection);
            ...
            {
                //Kitap silinir.
                SqlCommand deleteCommand = new SqlCommand("DELETE FROM TableKitaplar WHERE KitapAdi = @p1", SqlConnection);
